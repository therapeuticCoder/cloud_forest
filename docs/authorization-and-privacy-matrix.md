...
| Claim state                                       | Before claim, an eligible current viewer matching the Care's current layer may attempt a claim. After the first successful claim, only requester and giver may receive the active participant projection while their Connection remains current. | Losing claimers and all unrelated Party or Tribe viewers receive no claimed-Care projection or claimant identity. Removed, disconnected, blocked, and unauthenticated callers cannot claim or retain shared access.                                                                                        |
