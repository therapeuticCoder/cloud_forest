...
function toReceiveCareRequest(
  ...
  return {
    ...
    location: request.location ?? request.handoffStyle,
    requirements: request.requirements ?? request.foodWorks,
    sensitivities: request.sensitivities ?? request.foodDoesNotWork,
