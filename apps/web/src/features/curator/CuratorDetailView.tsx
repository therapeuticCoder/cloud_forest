...
import { characterRelationshipOptions } from "./characterRelationshipOptions";
...
function editorRelationshipShape(value: string) {
  return characterRelationshipOptions.includes(
    value as (typeof characterRelationshipOptions)[number],
  )
    ? value
    : "Something else";
}
